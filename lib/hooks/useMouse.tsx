...
export function useMouse<T extends HTMLElement = HTMLElement>(
  ...
  useEffect(() => {
    ...
    target.addEventListener("mousemove", handleMouseMove as EventListenerOrEventListenerObject);
    if (resetOnExit) {
      target.addEventListener("mouseleave", handleMouseLeave);
    }
    return () => {
      target.removeEventListener("mousemove", handleMouseMove as EventListenerOrEventListenerObject);
      if (resetOnExit) {
